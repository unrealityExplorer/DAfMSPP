...
server <- function(input, output, session) {
  ...
  observeEvent(input$save_solo_chart_plot, {
    ...
    save_ggplot_modal("solo_chart", output_format = c("png", "jpeg", "bmp", "tiff"))
  ...
  observeEvent(input$save_comparison_num_variables_chart, {
    save_ggplot_modal("groups_comparison_num_var_chart", output_format = c("png", "jpeg", "bmp", "tiff"))
  })
  ...
  observeEvent(input$save_comparison_cat_variables_chart, {
    save_ggplot_modal("groups_comparison_cat_var_chart", output_format = c("png", "jpeg", "bmp", "tiff"))
  })
  ...
  observeEvent(input$save_corr_chart, {
    save_ggplot_modal("corr_chart", output_format = c("png", "jpeg", "bmp", "tiff"))
  })
